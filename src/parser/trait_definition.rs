use crate::ast::{Stmt, TraitMember};
...
pub fn parser() -> impl Parser<char, Stmt, Error = Simple<char>> {
    let start = just("trait").padded();

    let sequence = || {
        word_chars().or_not().map(|opt| match opt {
            Some(ch) => ch,
            None => "".to_string(),
        })
    };
    ...
    let member = just("default")
        ...
        .then(notation)
        .map(|((default, labels), notation)| TraitMember {
            default,
            labels,
            notation,
        });
            ...
            Ok(Stmt::Trait {
                ...
                members: vec![
                    ...
                    (
                        45..53,
                        TraitMember {
                            labels: vec![(45..53, "alveolar".into())],
                            notation: None,
                            default: false
                        }
                    ),
            ...
            Ok(Stmt::Trait {
                ...
                members: vec![
                    (
                        30..42,
                        TraitMember {
                            labels: vec![(30..37, "primary".into())],
                            notation: Some((40..42, "ˈ_".into())),
                            default: false
                        }
                    ),
                    (
                        52..66,
                        TraitMember {
                            labels: vec![(52..61, "secondary".into())],
                            notation: Some((64..66, "ˌ_".into())),
                            default: false
                        }
                    ),
                ],
            ...
            Ok(Stmt::Trait {
                ...
                members: vec![
                    ...
                    (
                        53..62,
                        TraitMember {
                            labels: vec![(53..57, "long".into())],
                            notation: Some((60..62, "_:".into())),
                            default: false
                        }
                    ),
                    (
                        72..86,
                        TraitMember {
                            labels: vec![(72..80, "overlong".into())],
                            notation: Some((83..86, "_::".into())),
                            default: false
                        }
                    ),
                ],
